...
if ((x < room_width - 128) and (y > 128) and (x > 128) and (y < room_height - 128) and not place_meeting(x, y, obj_wall_parent) and not place_meeting(x, y, obj_pain) and not place_meeting(x, y, obj_pit)) {
