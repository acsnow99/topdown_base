...
if ((x < room_width - 128) and (y > 128) and (x > 128) and (y < room_height - 128) and (distance_to_object(obj_wall_parent) > 32) and (distance_to_object(obj_pain) > 32) and (distance_to_object(obj_pit) > 32)) {
